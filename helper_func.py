...
# ✅ Check if a user is admin (owner also treated as admin level)
...
# ✅ Extract message ID from forwarded or link
...
# ✅ Convert seconds into expiry format
